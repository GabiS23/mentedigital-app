            ...
            <div class="card">
                <form method="GET" id="form" name="form" action="#" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="contenido">
                            <div class="crud">
                                <h4>Generar proforma</h4>
                                <a id="atras" href="{{route('form_nueva_proforma')}}" data-toggle="tooltip" data-placement="top" title="Atras"><i class="fa fa-solid fa-arrow-left"></i></a>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
